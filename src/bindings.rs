...
pub mod ctf_msg_iter_medium_status {
    #[doc = " Medium operations status codes.  These use the same values as"]
    #[doc = " libbabeltrace2."]
    pub type Type = ::std::os::raw::c_int;
    #[doc = " End of file."]
    #[doc = ""]
    #[doc = " The medium function called by the message iterator"]
    #[doc = " function reached the end of the file."]
    pub const CTF_MSG_ITER_MEDIUM_STATUS_EOF: Type = 1;
    #[doc = " There is no data available right now, try again later."]
...
pub mod ctf_msg_iter_status {
    #[doc = " CTF message iterator API status code."]
    pub type Type = ::std::os::raw::c_int;
    #[doc = " End of file."]
    #[doc = ""]
    #[doc = " The medium function called by the message iterator"]
    ...
    #[doc = " There is no data available right now, try again later."]
    #[doc = ""]
    #[doc = " Some condition resulted in the"]
    #[doc = " ctf_msg_iter_medium_ops::request_bytes() user function not"]
    #[doc = " having access to any data now. You should retry calling the"]
    #[doc = " last called message iterator function once the situation"]
    #[doc = " is resolved."]
...
#[doc = " Medium operations."]
#[doc = ""]
#[doc = " Those user functions are called by the message iterator"]
#[doc = " functions to request medium actions."]
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ctf_msg_iter_medium_ops {
    #[doc = " Returns the next byte buffer to be used by the binary file"]
    #[doc = " reader to deserialize binary data."]
    #[doc = ""]
    #[doc = " This function \\em must be defined."]
    #[doc = ""]
    #[doc = " The purpose of this function is to return a buffer of bytes"]
    #[doc = " to the message iterator, of a maximum of \\p request_sz"]
    #[doc = " bytes. If this function cannot return a buffer of at least"]
    #[doc = " \\p request_sz bytes, it may return a smaller buffer. In"]
    #[doc = " either cases, \\p buffer_sz must be set to the returned buffer"]
    #[doc = " size (in bytes)."]
    #[doc = ""]
    #[doc = " The returned buffer's ownership remains the medium, in that"]
    #[doc = " it won't be freed by the message iterator functions. The"]
    #[doc = " returned buffer won't be modified by the message"]
    #[doc = " iterator functions either."]
    #[doc = ""]
    #[doc = " When this function is called for the first time for a given"]
    #[doc = " file, the offset within the file is considered to be 0. The"]
    #[doc = " next times this function is called, the returned buffer's"]
    #[doc = " byte offset within the complete file must be the previous"]
    #[doc = " offset plus the last returned value of \\p buffer_sz by this"]
    #[doc = " medium."]
    #[doc = ""]
    #[doc = " This function must return one of the following statuses:"]
    #[doc = ""]
    #[doc = "   - <b>#CTF_MSG_ITER_MEDIUM_STATUS_OK</b>: Everything"]
    #[doc = "     is okay, i.e. \\p buffer_sz is set to a positive value"]
    #[doc = "     reflecting the number of available bytes in the buffer"]
    #[doc = "     starting at the address written in \\p buffer_addr."]
    #[doc = "   - <b>#CTF_MSG_ITER_MEDIUM_STATUS_AGAIN</b>: No data is"]
    #[doc = "     available right now. In this case, the message"]
    #[doc = "     iterator function called by the user returns"]
    #[doc = "     #CTF_MSG_ITER_STATUS_AGAIN, and it is the user's"]
    #[doc = "     responsibility to make sure enough data becomes available"]
    #[doc = "     before calling the \\em same message iterator"]
    #[doc = "     function again to continue the decoding process."]
    #[doc = "   - <b>#CTF_MSG_ITER_MEDIUM_STATUS_EOF</b>: The end of"]
    #[doc = "     the file was reached, and no more data will ever be"]
    #[doc = "     available for this file. In this case, the message"]
    #[doc = "     iterator function called by the user returns"]
    #[doc = "     #CTF_MSG_ITER_STATUS_EOF. This must \\em not be"]
    #[doc = "     returned when returning at least one byte of data to the"]
    #[doc = "     caller, i.e. this must be returned when there's"]
    #[doc = "     absolutely nothing left; should the request size be"]
    #[doc = "     larger than what's left in the file, this function must"]
    #[doc = "     return what's left, setting \\p buffer_sz to the number of"]
    #[doc = "     remaining bytes, and return"]
    #[doc = "     #CTF_MSG_ITER_MEDIUM_STATUS_EOF on the \\em following"]
    #[doc = "     call."]
    #[doc = "   - <b>#CTF_MSG_ITER_MEDIUM_STATUS_ERROR</b>: A fatal"]
    #[doc = "     error occurred during this operation. In this case, the"]
    #[doc = "     message iterator function called by the user returns"]
    #[doc = "     #CTF_MSG_ITER_STATUS_ERROR."]
    #[doc = ""]
    #[doc = " If #CTF_MSG_ITER_MEDIUM_STATUS_OK is not returned, the"]
    #[doc = " values of \\p buffer_sz and \\p buffer_addr are \\em ignored by"]
    #[doc = " the caller."]
    #[doc = ""]
    #[doc = " @param request_sz\tRequested buffer size (bytes)"]
    #[doc = " @param buffer_addr\tReturned buffer address"]
    #[doc = " @param buffer_sz\tReturned buffer's size (bytes)"]
    #[doc = " @param data\t\tUser data"]
    #[doc = " @returns\t\tStatus code (see description above)"]
    ...
    >,
    #[doc = " Repositions the underlying stream's position."]
    #[doc = ""]
    #[doc = " This *optional* method repositions the underlying stream"]
    #[doc = " to a given absolute position in the medium."]
    #[doc = ""]
    #[doc = " @param offset\tOffset to use for the given directive"]
    #[doc = " @param data\t\tUser data"]
    #[doc = " @returns\t\tOne of #ctf_msg_iter_medium_status values"]
    ...
    >,
    #[doc = " Called when the message iterator wishes to inform the medium that it"]
    #[doc = " is about to start a new packet."]
    #[doc = ""]
    #[doc = " After the iterator has called switch_packet, the following call to"]
    #[doc = " request_bytes must return the content at the start of the next"]
    #[doc = " packet."]
    pub switch_packet: ::std::option::Option<
        unsafe extern "C" fn(data: *mut ::std::os::raw::c_void) -> ctf_msg_iter_medium_status::Type,
    >,
    #[doc = " Returns a stream instance (weak reference) for the given"]
    #[doc = " stream class."]
    #[doc = ""]
    #[doc = " This is called after a packet header is read, and the"]
    #[doc = " corresponding stream class is found by the message"]
    #[doc = " iterator."]
    #[doc = ""]
    #[doc = " @param stream_class\tStream class of the stream to get"]
    #[doc = " @param stream_id\tStream (instance) ID of the stream"]
    #[doc = "\t\t\tto get (-1ULL if not available)"]
    #[doc = " @param data\t\tUser data"]
    #[doc = " @returns\t\tStream instance (weak reference) or"]
    #[doc = "\t\t\t\\c NULL on error"]
...
extern "C" {
    #[doc = " Creates a CTF message iterator."]
    #[doc = ""]
    #[doc = " Upon successful completion, the reference count of \\p trace is"]
    #[doc = " incremented."]
    #[doc = ""]
    #[doc = " @param trace\t\t\tTrace to read"]
    #[doc = " @param max_request_sz\tMaximum buffer size, in bytes, to"]
    #[doc = "\t\t\t\trequest to"]
    #[doc = "\t\t\t\tctf_msg_iter_medium_ops::request_bytes()"]
    #[doc = " \t\t\t\tat a time"]
    #[doc = " @param medops\t\tMedium operations"]
    #[doc = " @param medops_data\t\tUser data (passed to medium operations)"]
    #[doc = " @returns\t\t\tNew CTF message iterator on"]
    #[doc = "\t\t\t\tsuccess, or \\c NULL on error"]
...
extern "C" {
    #[doc = " Destroys a CTF message iterator, freeing all internal resources."]
    #[doc = ""]
    #[doc = " The registered trace's reference count is decremented."]
    #[doc = ""]
    #[doc = " @param msg_iter\t\tCTF message iterator"]
    pub fn ctf_msg_iter_destroy(msg_iter: *mut ctf_msg_iter);
}
extern "C" {
    #[doc = " Returns the next message from a CTF message iterator."]
    #[doc = ""]
    #[doc = " Upon successful completion, #CTF_MSG_ITER_STATUS_OK is"]
    #[doc = " returned, and the next message is written to \\p msg."]
    #[doc = " In this case, the caller is responsible for calling"]
    #[doc = " bt_message_put() on the returned message."]
    #[doc = ""]
    #[doc = " If this function returns #CTF_MSG_ITER_STATUS_AGAIN, the caller"]
    #[doc = " should make sure that data becomes available to its medium, and"]
    #[doc = " call this function again, until another status is returned."]
    #[doc = ""]
    #[doc = " @param msg_iter\t\tCTF message iterator"]
    #[doc = " @param message\t\tReturned message if the function's"]
    #[doc = "\t\t\t\treturn value is #CTF_MSG_ITER_STATUS_OK"]
    #[doc = " @returns\t\t\tOne of #ctf_msg_iter_status values"]
